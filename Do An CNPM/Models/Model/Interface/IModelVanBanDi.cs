...
{
    internal interface IModelVanBanDi
    {
        [Key]
        int ID { get; set; }
        ...
        [Required(ErrorMessage = "Ngày soạn không được phép để trống")]
        [DataType(DataType.Date)]
        [DisplayFormat(ApplyFormatInEditMode = true, DataFormatString = "{0:dd/MM/yyyy}")]
        DateTime NgaySoan { get; set; }
        ...
        [Required(ErrorMessage = "Đơn vị nhận không được phép để trống")]
        [StringLength(255, ErrorMessage = "Số ký tự phải nhỏ hơn 255")]
        string DonViNhan { get; set; }
